...
MACRO_ITEMS = [
    ...
    # ── 원자재 ────────────────────────────
    # ── 원자재 ────────────────────────────
    ('금(COMEX선물)',  'GC=F',      'USD', '안전자산, 달러와 역상관'),
    ('브렌트유(ICE)',   'BZ=F',      'USD', '글로벌 원유 기준가'),
    ('WTI 원유(NYMEX)', 'CL=F',      'USD', '미국 원유 기준가, 인플레 지표'),
    ('구리(COMEX선물)',  'HG=F',      'USD', '경기 선행 지표 (닥터 쿠퍼)'),
    # ── 미국 선물 지수 (CME) ──────────────
    ('다우지수(CME선물)', 'YM=F',      'pt',  '미국 우량주 30종 선물'),
    ('S&P500(CME선물)',  'ES=F',      'pt',  'S&P500 선물 (24H 거래)'),
    ('나스닥100(CME선물)', 'NQ=F',      'pt',  '기술주 나스닥100 선물'),
    ('러셀2000(CME선물)', 'RTY=F',     'pt',  '미국 중소형주 선물'),
    # ── 기타 지수 ─────────────────────────
